...
if __name__ == '__main__':
    ...
    ########## preprocessing #################
    try:
        data, key_data, cat_vars = Preprocessing(data, log, target_name, processing=True)
    except Exception as e:
    ...
    ##### model train #####
    try:
        data = Data_cleaning(data, target_name, log, MODEL_PREDICTION_TYPE, cat_vars, processing=True) 
    except Exception as e:
    ...
    ### Processing ###
    try:
        Model_processing(data, log, model_type,MODEL_PREDICTION_TYPE,target_name, key_data)
    except Exception as e:
        log.error(f'{e} : {target_name} model processing error')
    else:
        log.info(f'finish model processing : {target_name}')   
